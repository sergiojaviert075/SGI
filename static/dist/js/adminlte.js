...
(function (global, factory) {
  ...
  var CLASS_NAME_NAVBAR_FIXED = 'layout-df-fixed';
  var CLASS_NAME_NAVBAR_SM_FIXED = 'layout-sm-df-fixed';
  var CLASS_NAME_NAVBAR_MD_FIXED = 'layout-md-df-fixed';
  var CLASS_NAME_NAVBAR_LG_FIXED = 'layout-lg-df-fixed';
  var CLASS_NAME_NAVBAR_XL_FIXED = 'layout-xl-df-fixed';
  ...
  var ControlSidebar = /*#__PURE__*/function () {
    ...
    _proto._fixScrollHeight = function _fixScrollHeight() {
      ...
      var dfFixed = this._isNavbarFixed() && $__default["default"](SELECTOR_HEADER$1).css('position') === 'fixed';
      ...
      if (footerFixed && dfFixed) {
        $controlsidebarContent.css('height', '100%');
        $controlSidebar.css('height', '');
      } else if (footerFixed || dfFixed) {
        $controlsidebarContent.css('height', '100%');
  ...
  var SELECTOR_TAB_NAVBAR_NAV = SELECTOR_CONTENT_WRAPPER + ".iframe-mode .df-nav";
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto._fixHeight = function _fixHeight(tabEmpty) {
      ...
      if ($__default["default"]('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        ...
        var dfHeight = $__default["default"](SELECTOR_TAB_NAV).outerHeight();
        $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING + ", " + SELECTOR_CONTENT_IFRAME).height(windowHeight - dfHeight);
        $__default["default"](SELECTOR_CONTENT_WRAPPER).height(windowHeight);
      } else {
        var contentWrapperHeight = parseFloat($__default["default"](SELECTOR_CONTENT_WRAPPER).css('height'));

        var _dfHeight = $__default["default"](SELECTOR_TAB_NAV).outerHeight();

        if (tabEmpty == true) {
          setTimeout(function () {
            $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING).height(contentWrapperHeight - _dfHeight);
          }, 50);
        } else {
          $__default["default"](SELECTOR_CONTENT_IFRAME).height(contentWrapperHeight - _dfHeight);
        }
      }
    } // Static
    ;
  ...
  var DATA_KEY$3 = 'lte.df-search';
  var JQUERY_NO_CONFLICT$3 = $__default["default"].fn[NAME$3];
  var SELECTOR_TOGGLE_BUTTON = '[data-widget="df-search"]';
  var SELECTOR_SEARCH_BLOCK = '.df-search-block';
  var SELECTOR_SEARCH_INPUT = '.form-control';
  var CLASS_NAME_OPEN$1 = 'df-search-open';
  var Default$3 = {
    resetOnClose: true,
  ...
  $__default["default"](document).on('click', SELECTOR_TOGGLE_BUTTON, function (event) {
    ...
    if (button.data('widget') !== 'df-search') {
